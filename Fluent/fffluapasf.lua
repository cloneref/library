	...
	function Element:New(Idx, Config)
		...
		local function ApplyFilter()
			...
			task.spawn(function()
				...
				task.wait()
				if RecalculateCanvasSize then
					pcall(RecalculateCanvasSize)
				end
				task.wait()
				if RecalculateListSize then
					pcall(RecalculateListSize)
				end
				task.wait()
				if RecalculateListPosition then
					pcall(RecalculateListPosition)
				end
			end)
		end
